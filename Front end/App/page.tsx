...
const projectionData = [
  { date: "2023-10-01", balance: 3000, isPast: true },
  { date: "2023-10-08", balance: 2500, isPast: true },
  { date: "2023-10-15", balance: 2000, isPast: true },
  { date: "2023-10-22", balance: 1500, isPast: false },
  { date: "2023-10-29", balance: 1000, isPast: false },
  { date: "2023-11-05", balance: 500, isPast: false },
  { date: "2023-11-12", balance: 0, isPast: false },
  { date: "2023-11-19", balance: -500, isPast: false },
]

const upcomingBills = [
  { id: 1, name: "Rent", dueDate: "2023-10-10", amount: 800, status: "paid" },
  { id: 2, name: "Electricity", dueDate: "2023-10-15", amount: 200, status: "pending" },
  { id: 3, name: "Internet", dueDate: "2023-10-20", amount: 100, status: "pending" },
]
                  ...
                  <CardContent className="relative">
                    ...
                    <div className="space-y-3 pt-4 border-t border-border/50">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-semibold font-mono">$3,920</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-muted-foreground">Pending Bills</span>
                        <span className="font-semibold text-chart-5 font-mono">-$2,360</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-muted-foreground">Buffer</span>
                        <span className="font-semibold text-chart-4 font-mono">-$880</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
